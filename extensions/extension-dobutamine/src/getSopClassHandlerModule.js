...
const sopClassHandlerName = 'dobutamine';
...
const makeDisplaySet = instances => {
  ...
  imageSet.setAttributes({
    ...
    isStress: isDobutamine(instance),
    isDobutamine: isDobutamine(instance),
...
const isDobutamine = instance => {
  const performedProcedureStepDescription = String(
    instance.PerformedProcedureStepDescription || ''
  );
  const seriesDescription = String(instance.SeriesDescription || '');
  const protocolName = String(instance.ProtocolName || '');

  return /dobutamine/i.test(
